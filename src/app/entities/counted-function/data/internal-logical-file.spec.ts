...
import { InternalLogicalFile } from './internal-logical-file';

describe('InternalLogicalFile', () => {
  it('should create an instance', () => {
    expect(new InternalLogicalFile()).toBeTruthy();
  });
});

describe('InternalLogicalFile.calculateContribution()', () => {
  it('should return correct values', () => {
    const testObject = new InternalLogicalFile();

    expect(testObject.calculateContribution(Complexity.LOW)).toEqual(7);
    expect(testObject.calculateContribution(Complexity.MEDIUM)).toEqual(10);
    expect(testObject.calculateContribution(Complexity.HIGH)).toEqual(15);
  });
});

describe('InternalLogicalFile.calculateComplexity()', () => {
