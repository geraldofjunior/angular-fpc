...
import { ExternalOutput } from './external-output';

describe('ExternalOutput', () => {
  it('should create an instance', () => {
    expect(new ExternalOutput()).toBeTruthy();
  });
});

describe('ExternalOutput.calculateContribution()', () => {
  it('should return correct values', () => {
    const testObject = new ExternalOutput();

    expect(testObject.calculateContribution(Complexity.LOW)).toEqual(4);
    expect(testObject.calculateContribution(Complexity.MEDIUM)).toEqual(5);
    expect(testObject.calculateContribution(Complexity.HIGH)).toEqual(7);
  });
});

describe('ExternalOutput.calculateComplexity()', () => {
